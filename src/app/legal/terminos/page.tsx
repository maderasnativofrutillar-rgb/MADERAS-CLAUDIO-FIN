  ...
  return (
    <div className="container mx-auto px-4 py-12 md:py-24">
      <div className="prose max-w-4xl mx-auto">
        ...
        <p>Bienvenido a Madera Nativo Sur. Estos términos y condiciones describen las reglas y regulaciones para el uso del sitio web de Madera Nativo Sur.</p>
        ...
        <p>A menos que se indique lo contrario, Madera Nativo Sur y/o sus licenciantes son dueños de los derechos de propiedad intelectual de todo el material en Madera Nativo Sur. Todos los derechos de propiedad intelectual están reservados. Puedes ver y/o imprimir páginas desde https://maderanativosur.cl para tu uso personal sujeto a las restricciones establecidas en estos términos y condiciones.</p>
        <p>No debes:</p>
        <ul>
          <li>Republicar material de https://maderanativosur.cl</li>
          <li>Vender, alquilar o sublicenciar material de https://maderanativosur.cl</li>
          <li>Reproducir, duplicar o copiar material de https://maderanativosur.cl</li>
        </ul>
        ...
        <p>Todos los precios están en Pesos Chilenos (CLP) e incluyen los impuestos aplicables. Nos reservamos el derecho de cambiar los precios en cualquier momento sin previo aviso. El pago debe realizarse en el momento de la compra a través de las pasarelas de pago disponibles.</p>
        
        <h2>4. Envíos y Entregas</h2>
        <p>Los tiempos de envío y los costos se detallarán durante el proceso de compra. Haremos todo lo posible para cumplir con los plazos de entrega estimados, pero no nos hacemos responsables de los retrasos causados por terceros o por fuerza mayor.</p>
        ...
        <h2>7. Contacto</h2>
        <p>Si tienes alguna pregunta sobre estos Términos y Condiciones, puedes contactarnos a través de nuestra página de <a href="/contacto">contacto</a>.</p>
      </div>
    </div>
  );
}
